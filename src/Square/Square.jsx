...
const Square = ({ setGameState, socket, currentElement, playingAs, gameState, setFinishedState, finishedState, id, currentPlayer, setCurrentPlayer, finishedArrayState }) => {
